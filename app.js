...
const MATCHES = {
  octavos: [
    ...
    { id:3,  home:'Kyburex', away:'Joshua_smith_503',       scoreH:0, scoreA:1, date:'11 Mayo 2026', time:'8:45 AM',   status:'finished',   emoji:['🐲','🦊'] },

    { id:4,  home:'Ramirez123', away:'lemus_17',             scoreH:0, scoreA:3, date:'11 Mayo 2026', time:'8:45 AM',   status:'finished',   emoji:['🐻','🏹'] },
...
{ id:6,  home:'Kyburex', away:'Lazo26',                    scoreH:0, scoreA:5, date:'11 Mayo 2026', time:'9:00 AM',   status:'finished',   emoji:['🌊','🌪️'] },
  ...
  cuartos: [
    { id:9,   home:'BR', away:'Joshua_Smith', scoreH:4, scoreA:3, date:'15 Mayo 2026', time:'8:00 AM',  status:'finished', emoji:['🦁','🐲'] },


    { id:10,  home:'Gaitan_gzz', away:'lemus_17', scoreH:1, scoreA:5, date:'15 Mayo 2026', time:'8:00 AM',  status:'finished', emoji:['🦁','🐲'] },


    { id:11,  home:'Noe de Jesús', away:'Gaitan_gzz', scoreH:0, scoreA:0, date:'15 Mayo 2026', time:'8:00 AM',  status:'pending', emoji:['🦁','🐲'] },



    { id:12,  home:'Remi', away:'Lazo26', scoreH:5, scoreA:0, date:'15 Mayo 2026', time:'8:00 AM',  status:'finished', emoji:['🦁','🐲'] },
  ...
  tercero: [
    { id:15, home:'Remi', away:'Por definir', scoreH:0, scoreA:0, date:'15 Mayo 2026', time:'10:00 AM', status:'pending', emoji:['🥉','🥉'] },
  ],
  final: [
    { id:16, home:'Por definir', away:'lemus_17', scoreH:0, scoreA:0, date:'15 Mayo 2026', time:'10:00 AM', status:'pending', emoji:['👑','👑'] },
  ],
};
